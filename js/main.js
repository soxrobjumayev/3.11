...
for (var i = 0; i < movies.length; i++ ){
    ...
    movieContainer.className = "movie-item-container"


   
    var idEL = document.createElement("div")
    idEL.setAttribute("class","id")
    idEL.textContent = movies[i].id+"__::ID"
    movieContainer.appendChild(idEL)


    var movieEL = document.createElement("div")
    movieEL.setAttribute("class","moviess")
    movieEL.textContent = movies[i].title+"__::TITLE"
    movieContainer.appendChild(movieEL)

    var yearEL = document.createElement("div")
    yearEL.setAttribute("class","yearr")
    yearEL.textContent = movies[i].year+"__::YEAR"
    movieContainer.appendChild(yearEL)

    var genresEL = document.createElement("div")
    genresEL.setAttribute("class","genres")
    genresEL.textContent = movies[i].genres+"__::GENRES"
    movieContainer.appendChild(genresEL)

    var directorEL = document.createElement("div")
    directorEL.setAttribute("class","director")
    directorEL.textContent = movies[i].director+"__::DIRECTOR"
    movieContainer.appendChild(directorEL)

    var actorsEL = document.createElement("div")
    actorsEL.setAttribute("class","actors")
    actorsEL.textContent = movies[i].actors+"__::ACTORS"
    movieContainer.appendChild(actorsEL)

    var descriptionEL = document.createElement("div")
    descriptionEL.setAttribute("class","description")
    descriptionEL.textContent = movies[i].description+"__::DESCRIPTION"
    movieContainer.appendChild(descriptionEL)

    // var  imageUrlEL = document.createElement("div")
    // imageUrlEL.setAttribute("class"," imageUrl")
    // imageUrlEL.textContent = movies[i]. imageUrl
    // movieContainer.appendChild( imageUrlEL)




    
    moviesEL.appendChild(movieContainer)}
// var moviesEL = document.querySelector(".movie")

// for (var i = 0; i < movies.length; i++ ){
//     var card_titleeEL = document.createElement("div")
//     card_titleeEL.setAttribute("class","movie")
//     card_titleeEL.textContent = movies[i].title
//     moviesEL.appendChild(card_titleeEL)
    
// }

// var imgEL = document.querySelector(".img-fluid")

// for (var i = 0; i < movies.length; i++ ){
//     var img_fluiddEL = document.createElement("img")
//     img_fluiddEL.setAttribute("class","img-fluid")
//     img_fluiddEL.textContent = movies[i].imageUrl
//     imgEL.appendChild(img_fluiddEL)
    
// }

// var mutEL = document.querySelector(".text-muted")

// for (var i = 0; i < movies.length; i++ ){
//     var texttmutedEL = document.createElement("small")
//     texttmutedEL.setAttribute("class","text-muted")
//     texttmutedEL.textContent = movies[i].year
//     mutEL.appendChild(texttmutedEL)
